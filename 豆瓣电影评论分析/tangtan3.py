...
def getContent(requrl,headers,cookies,page):
    ...
    for item in comment_div_lits:
        ...
        with open('./tangtan3.csv','a+',encoding='utf-8',newline='') as f:
            writer = csv.writer(f)
...
def main():
    ...
    for i in range(0,600,20):
        ...
        requrl = "https://movie.douban.com/subject/27619748/comments?start=" + str(i) + "&limit=20&sort=new_score&status=P"
